<table id="tblappdetail" class="display table border order-column table-hover" style="width:100%">
    <thead>
        <tr class="font-weight-bold bg-primary" style="color:white;">
            ...
            <th style="text-align:center;">
                <button type="button" name="btnupdateakunedittambah" id="btnupdateakunedittambah" class="btn font-weight-bold btn-danger btn-sm"><i class="fas fa-plus"></i></button>
            </th>
        </tr>
    </thead>
    <tbody>
    ...
    $(document).ready(function() {
        ...
        $("#btnupdateakunedittambah").click(function() {
            ...
            $.post("cariapps?stt=app", {},
                function(data) {
                    $("#lstappsedit").html(data);
                    $("#lsttipeaksesedit").html("<option value=''>-- Data akses tidak ditemukan --</option>");
                });
        });
        ...
        $('#tblappdetail').DataTable().destroy();
