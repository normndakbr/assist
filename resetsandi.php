...
if (isset($_GET['token'])) {
    ...
    if ($sqlcek->num_rows > 0) {
        ...
        header("Location: http://localhost:8080/IndeximLP/errorreset.php");
    }
} else {
    header("Location: http://localhost:8080/IndeximLP/errorreset.php");
}
    ...
    <div class="container">
        ...
        <div class="content shadow rounded bg-white">
            <div class="content rounded-top" style='background-color:#00005c;'>
                <br>
                <h3 style='text-align: center; font-weight:bold; color: yellow;'>Reset Sandi Akun</h3>
                <h3 style='text-align: center; font-weight:bold; color: yellow;'>Administration Integrated System</h3>
                <br>
            </div>
            <br>
            ...
            <div class="container bg_white text-Align:Center">
                ...
                <div class="row text-center">
                    <div class="col-lg-2 offset-5">
                        <button id="btnsimpansandi" class="btn font-weight-bold btn-primary" style='color:white;' value="">Simpan Sandi</button>
                    </div>
                    <br>
                </div>
                <br>
    ...
    <script>
        $(document).ready(function() {
            $("#btnsimpansandi").click(function() {
                var btnsimpan = $("#btnsimpansandi").text();

                if (btnsimpan == 'Simpan Sandi') {
