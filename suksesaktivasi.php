    ...
    <div class="container">
        ...
        <div class="content shadow rounded bg-white">
            <div class="content rounded-top" style='background-color:#00005c;'>
                <br>
                <h3 style='text-align: center; font-weight:bold; color: yellow;'>Aktivasi Berhasil</h3>
                <br>
            </div>
            <br>
            <h4 style='text-align: center; color:black;'>Anda telah berhasil melakukan aktivasi akun di Licensing System</h4>
            <br>
        </div>
        <br>
    </div>
